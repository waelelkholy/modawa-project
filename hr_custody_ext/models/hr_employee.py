...
class HrCustody(models.Model):
    ...
    property_ids = fields.Many2many('custody.property',string="Custody IDS")
    ...
    def custody_view(self):
        for each1 in self:
            ...
            view_id = self.env.ref('hr_custody_ext.hr_custody_form_view').id
            if custody_ids:
    ...
    def equipment_view(self):
        for each1 in self:
            ...
            view_id = self.env.ref('hr_custody_ext.custody_custody_form_view').id
            if equipment_ids:
